package com.dwi.basic.injection.core;
 ...
 */
@Slf4j
public class DefCacheLoader extends CacheLoader<InjectionFieldExtPo, Map<Serializable, Object>> {
    /**
     * 侦听执行器服务
     */
    private final ListeningExecutorService backgroundRefreshPools;

    public DefCacheLoader(InjectionProperties.GuavaCache guavaCache) {
     ...
     */
    @Override
    public Map<Serializable, Object> load(@NonNull InjectionFieldExtPo type) {
     ...
     */
    @Override
    public ListenableFuture<Map<Serializable, Object>> reload(@NonNull InjectionFieldExtPo key, @NonNull Map<Serializable, Object> oldValue) {

package com.dwi.basic.injection.aspect;

import com.dwi.basic.annotation.injection.InjectionResult;
...
public class InjectionResultAspect {
    ...
    @Pointcut("@annotation(com.dwi.basic.annotation.injection.InjectionResult)")

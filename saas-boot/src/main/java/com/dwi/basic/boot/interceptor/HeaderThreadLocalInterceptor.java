package com.dwi.basic.boot.interceptor;
...
import static com.dwi.basic.boot.utils.WebUtils.getHeader;
...
public class HeaderThreadLocalInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (!ContextUtil.getBoot()) {
            ...
            ContextUtil.setTenant(getHeader(request, ContextConstants.JWT_KEY_TENANT)); //TODO

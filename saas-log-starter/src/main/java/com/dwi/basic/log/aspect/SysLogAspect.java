package com.dwi.basic.log.aspect;
...
import com.dwi.basic.context.ThreadLocalParam;
import com.dwi.basic.jackson.JsonUtil;
import com.dwi.basic.log.entity.OptLogDTO;
import com.dwi.basic.log.event.SysLogEvent;
import com.dwi.basic.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     *
     * execution(public * com.dwi.basic.base.controller.*.*(..)) 解释：
     * 第一个* 任意返回类型
     * 第二个* com.dwi.basic.base.controller包下的所有类
     * 第三个* 类下的所有方法
     * ()中间的.. 任意参数
     *
     * \@annotation(com.dwi.basic.annotation.log.SysLog) 解释：
     * 标记了@SysLog 注解的方法
     */
    @Pointcut("execution(public * com.dwi.basic.base.controller.*.*(..)) || @annotation(com.dwi.basic.annotation.log.SysLog)")

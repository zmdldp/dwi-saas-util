...
import static com.dwi.basic.database.properties.DatabaseProperties.PREFIX;
import static com.dwi.basic.database.properties.MultiTenantType.SCHEMA;
...
public class DatabaseProperties {
    public static final String PREFIX = "saas.database";
    /**
     * 是否启用 防止全表更新与删除插件
     */
     ...
     * 租户库 前缀
     */
    private String tenantDatabasePrefix = "saas_base";

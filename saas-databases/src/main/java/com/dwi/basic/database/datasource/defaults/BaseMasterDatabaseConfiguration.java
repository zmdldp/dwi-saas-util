package com.dwi.basic.database.datasource.defaults;
...
import com.dwi.basic.database.datasource.BaseDatabaseConfiguration;
 ...
 *
 * <p>
 * 不使用多数据源模式时，一个服务如何配置多数据源？以Authority服务举例
 * <p>
 * 1. 本类的子类的 @MapperScan(basePackages = {"com.dwi.basic"}) 修改为  @MapperScan(basePackages = {"com.dwi.basic.product.dao"})
 ...
 * 3. 在saas-xxx-server层复制该类，重命名为 SlaveDatabaseAutoConfiguration （跟AuthorityDatabaseAutoConfiguration放一起）
 ...
 * 6. SlaveDatabaseAutoConfiguration 中的 basePackages = {"com.dwi.basic"}, 修改为  basePackages = {"com.dwi.basic.order.dao"} # 这个路径根据你的情况修改
 ...
 * <p>
 * 完成上述修改后， 位于com.dwi.basic.product.dao 包下的dao 将操作  master 库， com.dwi.basic.order.dao中的dao 将操作slave库
 *
 * @author dwi

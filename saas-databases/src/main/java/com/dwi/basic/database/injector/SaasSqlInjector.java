package com.dwi.basic.database.injector;
...
import com.dwi.basic.database.injector.method.UpdateAllById;
 ...
 */
public class SaasSqlInjector extends DefaultSqlInjector {
    @Override

package com.dwi.basic.converter;
...
import static com.dwi.basic.utils.DateUtils.DEFAULT_DATE_FORMAT_EN;
import static com.dwi.basic.utils.DateUtils.DEFAULT_DATE_FORMAT_EN_MATCHES;
import static com.dwi.basic.utils.DateUtils.DEFAULT_DATE_FORMAT_MATCHES;
import static com.dwi.basic.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT;
import static com.dwi.basic.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT_EN;
import static com.dwi.basic.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT_EN_MATCHES;
import static com.dwi.basic.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT_MATCHES;
import static com.dwi.basic.utils.DateUtils.SLASH_DATE_FORMAT;
import static com.dwi.basic.utils.DateUtils.SLASH_DATE_FORMAT_MATCHES;
import static com.dwi.basic.utils.DateUtils.SLASH_DATE_TIME_FORMAT;
import static com.dwi.basic.utils.DateUtils.SLASH_DATE_TIME_FORMAT_MATCHES;
...
public class SaasLocalDateTimeDeserializer extends JSR310DateTimeDeserializerBase<LocalDateTime> {
    public static final SaasLocalDateTimeDeserializer INSTANCE = new SaasLocalDateTimeDeserializer();
    ...
    private SaasLocalDateTimeDeserializer() {
        this(DEFAULT_FORMATTER);
    }

    public SaasLocalDateTimeDeserializer(DateTimeFormatter formatter) {
        super(LocalDateTime.class, formatter);
    }

    protected SaasLocalDateTimeDeserializer(SaasLocalDateTimeDeserializer base, Boolean leniency) {
        super(base, leniency);
    }

    @Override
    protected SaasLocalDateTimeDeserializer withLeniency(Boolean leniency) {
        return new SaasLocalDateTimeDeserializer(this, leniency);
    }
